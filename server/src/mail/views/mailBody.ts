export const activateAccountMail = (
  confirmUrl: string,
  name: string,
            ...
            <table style="border-collapse: collapse;max-width: 700px;margin: auto;border: 10px;">
                <tbody style="background: #ffffff;">
                    ...
                    <tr>
                        <td class="content" style="background: #fff;border-bottom-left-radius: 6px;border-bottom-right-radius: 6px;padding-bottom: 40px;margin: 0 auto !important;clear: both !important;">
                            <div class="center" style="background: #ffffff;color: #54616a;padding: 0px 60px 40px;text-align: center;padding-bottom: 0px;margin: 40px 0;">
                                <h1 style="font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;margin-bottom: 10px;color: #54616a;margin: 0px 0 10px;line-height: 40px;font-weight: 400;font-size: 28px;padding-left: 40px;padding-right: 40px;padding-top: 0px;text-transform: capitalize;">Hello, ${name}!</h1>
                                <p style="font-weight: normal;padding: 0;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;line-height: 1.7;margin-bottom: 0;font-size: 15px;color: #54616a;opacity: 0.8;padding-left: 40px;padding-right: 40px;padding-bottom: 0;">This is secure email for changing password.</p>
                            </div>
